...
class Bot(BaseBot):
    async def on_start(self, session_metadata: SessionMetadata) -> None:
        print("working")
        await self.highrise.walk_to(Position(16.5 , 2.0 , 13.5 , "FrontLeft"))
    async def on_user_join(self, user: User, position: Position | AnchorPosition) -> None:
        print(f"{user.username} entrou na sala")   
        await self.highrise.send_whisper(user.id,f"Welcome {user.username} Use: !emote list or 1-97 For Emotes\n\nloop example: !loop 98 or !loop jetpack")
    ...
    async def on_chat(self, user: User, message: str) -> None:
        ...
        if message.lower().startswith("!tipall ") and user.username in ["ShoKytoo","Im_Melika","Helloitsdonut"]:
              parts = message.split(" ")
              if len(parts) != 2:
        ...
        if message.lower().startswith("!tipme ") and user.username in ["ShoKytoo","Im_Melika","Helloitsdonut"]:
                try:
        ...
        if        message.startswith("/tele") or              message.startswith("/tp") or              message.startswith("/fly") or     message.startswith("!tele") or      message.startswith("!tp") or     message.startswith("!fly"):
          if user.username in ["ShoKytoo","Im_Melika","Helloitsdonut"]:            await self.teleporter(message)
        ...
        if              message.startswith("Fairyfloat All") or                              message.startswith("/emote all fairyfloat") or       message.startswith("!emote all fairyfloat"):
          if user.username in ["ShoKytoo","Im_Melika","Helloitsdonut"]:
        ...
        if                            message.startswith("Summon") or         message.startswith("Summom") or         message.startswith("!summom") or        message.startswith("/summom") or        message.startswith("/summon") or  message.startswith("!summon"):
          if user.username == "fufishere" or user.username == "NotMayaaa_Df":
           target_username = message.split("@")[-1].strip()
        ...
        if message == "!fit 1" and user.username in ["ShoKytoo","Im_Melika","Helloitsdonut"]:
        ...
        if message == "!fit 2" and user.username in ["ShoKytoo","Im_Melika","Helloitsdonut"]:
        ...
        if message == "!fit 3"  and user.username in ["ShoKytoo","Im_Melika","Helloitsdonut"]:
...
Item(type='clothing', amount=1, id='earrings-n_room12019goldhoops', account_bound=False, active_palette=-1),
        ...
        if message == "!fit 4" and user.username in ["ShoKytoo","Im_Melika","Helloitsdonut"]:
        ...
        if message == "!fit 5" and user.username in ["ShoKytoo","Im_Melika","Helloitsdonut"]:
        ...
        if message == "!fit 6" and user.username in ["ShoKytoo","Im_Melika","Helloitsdonut"]:
        ...
        if message == "!fit 7" and user.username in ["ShoKytoo","Im_Melika","Helloitsdonut"]:
        ...
        if message == "!fit 8" and user.username in ["ShoKytoo","Im_Melika","Helloitsdonut"]:
...
Item(type='clothing', amount=1, id='earrings-n_room12019goldhoops', account_bound=False, active_palette=-1),
        ...
        if message == "!fit 9" and user.username in ["ShoKytoo","Im_Melika","Helloitsdonut"]:
        ...
        if message == "!fit 10" and user.username in ["ShoKytoo","Im_Melika","Helloitsdonut"]:
...
Item(type='clothing', amount=1, id='earrings-n_room12019goldhoops', account_bound=False, active_palette=-1),
        ...
        if message == "!fit 11" and user.username in ["ShoKytoo","Im_Melika","Helloitsdonut"]:
